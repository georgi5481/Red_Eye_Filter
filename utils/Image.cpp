...
PackedImage::PackedImage(const Resolution &res) : resolution(res), pixels(res.width * res.height) {
}
...
StrideImage::StrideImage(const Resolution &res): resolution(res),	redPixels(res.width * res.height),
